		...
		switch (@$regle[1]) {
			...
			case 'all': // Régle sur tous les posts
				$this->template->assign_vars([
					'EXT_DIR' => $this->ext_dir, //TODO DCMM: mettre un nom correspondant à cette extension !!
					'GEO_MAP_TYPE' => $regle[2],
					'MAP_KEYS' => @$config_locale['keys-js'],
					'LEAFLET_DIR' =>  // Includes leaflet js & css files & activate related templates
						@$config_locale['leaflet'] // External leaflet for test if any
						?: $this->ext_dir.'leaflet/' // By default in the extension
				]);
		}
	}
